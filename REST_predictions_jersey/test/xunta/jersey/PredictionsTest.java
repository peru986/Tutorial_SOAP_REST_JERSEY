...
public class PredictionsTest
{
    private static final String REST_SERVICE_URL
        = "http://localhost:8080/REST_predictions_jersey/webresources/predictions";

    private static final String PREDICTION_1_WHO
        = "Cornelius Tillman";
    private static final String PREDICTION_1_WHAT
