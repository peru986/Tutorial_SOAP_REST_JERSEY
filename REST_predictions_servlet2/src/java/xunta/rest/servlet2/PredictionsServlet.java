...
public class PredictionsServlet extends HttpServlet
{
    ...
    public void doPost( HttpServletRequest request, HttpServletResponse response )
    {
        ...
        Prediction p = predictions.addPrediction( who, what );

        /*
         * Generar respuesta OK
         */
        String msg = String.format( "Prediction %d creada", p.getId() );
        sendResponse( response, toXML( msg ), ContentType.XML );
    }
    ...
    public void doDelete( HttpServletRequest request, HttpServletResponse response )
    {
        ...
        /*
         * Sólo se permite borrar una Prediction cada vez
         */
        if ( id == -1 ) {
            sendStatusCode( response, HttpServletResponse.SC_BAD_REQUEST );
            return;
        ...
        try {
            ...
            String msg = String.format( "Prediction %d borrada", id );
            sendResponse( response, toXML( msg ), ContentType.XML );
        }
        catch (PredictionNotFoundException e) {
            String msg = String.format( "No existe la Prediction %d", id );
            sendResponse( response, toXML( msg ), ContentType.XML );
        }
        catch (Exception e) {
